...
To wire this strictly to your FPGA synthesizer, you will substitute this logging step with a conditional structure translating the `param` strings into memory-mapped AXI hardware writes.
